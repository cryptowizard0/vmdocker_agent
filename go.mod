module github.com/cryptowizard0/vmdocker_agent

go 1.25.0

require (
	github.com/cryptowizard0/vmdocker v0.0.2
...
replace github.com/xingj404-lab/agent-hub => /Users/sandyzhou/codex-project/agent-hub
